...
const  UpdateForm: React.FC = () => {
    ...
    ///(e) => update(e, product.articleNumber)

    return (
        <form method='puty' onSubmit={update} className="d-grid mb-5">
            <h3 className='display-6 mb-4'>Update Product</h3>
                <input placeholder='ID...'value={product.articleNumber} onChange={(e) => setProduct({...product,articleNumber: e.target.value}) }></input>
               ...
               <input placeholder='Tag...' value={product.tag} onChange={(e) => setProduct({...product,tag: e.target.value}) }></input>
